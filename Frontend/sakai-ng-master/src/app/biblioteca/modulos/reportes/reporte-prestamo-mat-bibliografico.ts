...
@Component({
    ...
    <div class="flex flex-col w-full gap-4">
                ...
                <div class="grid grid-cols-7 gap-4">
                    ...
                    <div class="flex flex-col gap-2 col-span-7 md:col-span-2 lg:col-span-2">
                    <label for="tipoPrestamo" class="block text-sm font-medium">Tipo pr&eacute;stamo</label>
                        <p-select [(ngModel)]="tipoPrestamoFiltro" [options]="dataTipoPrestamo" optionLabel="descripcion" placeholder="Seleccionar" />
                    </div>
...
export class ReportePrestamoMatBibliografico {
    titulo: string = "Préstamos de materiales bibliograficos";
    dataSede: Sedes[] = [];
